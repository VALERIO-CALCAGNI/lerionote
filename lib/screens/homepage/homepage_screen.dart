...
import 'package:lerionote/db/notes_database.dart';
import 'package:lerionote/models/note.dart';
import 'package:lerionote/routes.dart';
import 'package:lerionote/screens/homepage/components/empty_notes.dart';

import 'package:lerionote/screens/homepage/components/single_note.dart';
        ...
        child: Column(
          ...
          children: [
            const Padding(
              ...
              child: Text("Le mie note", style: kHeaderDarkTitle),
            ),
            Expanded(
                    ...
                    child: Dismissible(
                        ...
                        onDismissed: (direction) async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content:
                                const Text('Hai appena eliminato una nota'),
